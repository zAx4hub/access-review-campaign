...
> Access review campaign runner

**Author:** zAx4hub

## Problem

Access review campaign runner. Teams often rely on closed SaaS, brittle scripts, or untested prototypes for this niche.

## Solution

`access-review-campaign` is an installable TypeScript/Node toolkit by **zAx4hub** with a real **sandbox** engine, CLI, examples, and tests.
...
1. Core sandbox engine tailored to the problem
